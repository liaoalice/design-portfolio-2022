                    ...
                    <div className="project-description">
                        <p class="paragraph--large project-lede">
                            <p>Climate Donor is a non-profit that seeks to mitigate climate change through crowdfunding. <br></br><br></br>
                                I volunteered my skills to Climate Donor through Develop for Good, which matches non-profit organizations and governing agencies with project managers, developers, and designers early in their careers.</p>
                        </p>
                    </div>
            ...
            <div class="grid">
                <section class="project-main">
                    ...
                    <div class="body">
                        ...
                        <p>
                            Upon reviewing the Donor Dashboard prototype, developer Akaash Kolluri noted the following pain points:
                        </p>
                        <ul class="case-list">
                        ...
                        <p>
                            Akaash needed help with prototyping a design that could contain a filter <b>checkboxes for categories, a location input box, and a keyword search box</b>. With this solution, he proposed that "we update the sidebar to have a Search Projects tab as well." He also asked me whether this new Search Projects tab of his should be positioned above or below the Recommended tab on the dashboard side bar.
                        </p>
                        <p>
                    ...
                    <div className="body">
                        ...
                        <p>
                            To address Akaash's questions and ideas, I first sketched several wireframes on my iPad.
                        </p>
                        <p>
                            In my first wireframe, I decided to put the search box front and center for visibility purposes, and add a sidebar for filter checkboxes. While Akaash proposed putting the checkboxes underneath the search bar, I thought that would clutter the space underneath and make it a hassle for the user if they accidentally clicked on a checkbox rather than the search bar itself.
                        </p>
                        <p>
                    ...
                    <div className="body">
                        <h2>Building the Filter Component</h2>
                        <p>
                            With Akaash and the rest of the client's approval of the first wireframe and the new consolidated Projects tab, I began building the filter bar in Figma first. Since I realized both the Projects tab and the Search tab would make use of a filter bar, I decided to design it as a reusable component.
                        </p>
                        <p>
                            I also made use of Figma's Variants feature to simplify the component library and swap smaller components in and out.
                        </p>
                    </div>
                    <figure class="project-image project-image--full off-white">
                    ...
                    <div className="body">
                        ...
                        <br />
                        <h3>Building off an existing design system</h3>
                        <p>In previous projects, I came up with a design system from scratch. However, as the Climate Donor project portal already had an existing design system, I learned to design new features and improve UI layouts without modifying existing design language. Staying within the constraints of the existing design system also allowed me to focus more on interaction design than visual design.</p>
                    </div>
                </section>
            </div>
        </div>
