...
export default class CovidSupport extends React.Component {
    render() {
        return (
            <div class="project">
                ...
                <div class="grid">
                    <div className="project-intro">
                        <h1 class="project title">COVIDSupport</h1>
                        ...
                        <div className="detail second-detail">
                            <h2>Time</h2>
                            <p>6+ weeks, Fall 2020</p>
                        </div>
                        <div className="detail third-detail">
                            <h2>For</h2>
                            <p>CS 3891 course project <br></br>at Vanderbilt</p>
                        </div>
                    </div>
                </div>
                <div class="grid">
                    <section class="project-main">
                        ...
                        <div className="body">
                            <p>
                                Not only does the reorganization shift the focus of our app to the content that best addresses our users' pain points, it also reduces interaction costs and the navigation bar’s room for error. Research indicated that more than five navigation tabs made it difficult for a navigation bar to retain an optimum touch-target size.
                            </p>
                            <p>
                                I also removed the Messaging and Communities pages, replacing them with Discord integration instead. We originally created built-in social features to address how interviewees wanted communities that understood how they felt in quarantine, but test users responded that they would rather make use of existing social platforms.
                            </p>
                        </div>
                        <figure class="project-image project-image--full off-white">
                        ...
                        <div className="body">
                            <p>As part of the updated visuals, I added a versatile 6-column mobile grid. Restructuring our UI around the grid created a recognizable spatial pattern that enhances polish. Polish, in turn, can enhance a sense of trustworthiness——important for a medical app meant to relieve uncertainty.</p>
                        </div>
                        <figure class="project-image project-image--full blue">
